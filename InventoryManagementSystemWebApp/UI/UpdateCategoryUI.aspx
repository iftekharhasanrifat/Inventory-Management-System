<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCategoryUI.aspx.cs" Inherits="InventoryManagementSystemWebApp.UI.UpdateCategoryUI" %>
...
<body class="bg-light">
    ...
    <h2 class="text-center mt-4">Category Update</h2>
