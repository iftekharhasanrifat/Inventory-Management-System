<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyUI.aspx.cs" Inherits="InventoryManagementSystemWebApp.UI.CompanyUI" %>
...
<body class="bg-light">
    ...
    <h2 class="text-center mt-4">Company Setup</h2>
    <div class="d-flex justify-content-center mt-5">
        <form id="form1" style="width: 600px" runat="server">
            <div>
                ...
                <asp:GridView ID="companyGridView" BorderStyle="None" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-responsive mt-1">
                    <Columns>
